...
Useful perhaps for generating random keys for...
... a database or for creating security keys
'''
...
for count in range(0, 100):
    # Clear the variable
    rw = ''
    # Inner loop builds the word,
    # the number of iterations is the lenght of the word
